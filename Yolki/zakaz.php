...
$data = array(	'phone' => $phone,	'fio' => $name, 'comment' => $comment, 'domain' => 'www.elky-igolki.ru', 'goods' => $goodList);


$myCurl = curl_init();


curl_setopt_array($myCurl, array(	CURLOPT_URL => 'https://sw.leadvertex.ru/api/admin/addOrder.html?token=fhg4h72bfiu3bgiy',	CURLOPT_RETURNTRANSFER => true,	CURLOPT_POST => true,	CURLOPT_SSL_VERIFYPEER => false,	CURLOPT_POSTFIELDS => http_build_query($data),));$response = curl_exec($myCurl);
