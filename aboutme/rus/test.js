...
$("above2").clone().prependTo("above2_clone");
	function setHeiHeight() {
		...
		if(height<800 & absolute_width>1210){
			$('.above1').css({
				height: 1.3*$(window).height()-160 + 'px'
			});
		...
		if(absolute_width>=1030){
			...
			$(".above1 .description .first").css("fontSize",2.39 + 'em');
			$(".above1 .description .second").css("fontSize",2.997 + 'em');
			$(".above1 .description .third").css("fontSize",2.645 + 'em');
			$(".above1 .description .fourth").css("fontSize",2.53 + 'em');
			$(".above1 .description .fifth").css("fontSize",1.701 + 'em');
		}
			...
			$(".above1 .description .first").css("fontSize",2.21 + 'em');
			$(".above1 .description .second").css("fontSize",3.847 + 'em');
			$(".above1 .description .third").css("fontSize",3.38 + 'em');
			$(".above1 .description .fourth").css("fontSize",2.35 + 'em');
			$(".above1 .description .fifth").css("fontSize",1.6 + 'em');
		}

		else if(absolute_width<540 & absolute_width>=410) {
			$(".above1 .description .first").css("fontSize",1.84 + 'em');
			$(".above1 .description .second").css("fontSize",2.997 + 'em');
			$(".above1 .description .third").css("fontSize",2.645 + 'em');
			$(".above1 .description .fourth").css("fontSize",1.95 + 'em');
			$(".above1 .description .fifth").css("fontSize",1.701 + 'em');
		}

		else if(absolute_width<410 ) {
				$(".above1 .description .first").css("fontSize",1.37 + 'em');
			$(".above1 .description .second").css("fontSize",2.397 + 'em');
			$(".above1 .description .third").css("fontSize",2.110 + 'em');
			$(".above1 .description .fourth").css("fontSize",1.45 + 'em');
			$(".above1 .description .fifth").css("fontSize",0.851 + 'em');
		}
